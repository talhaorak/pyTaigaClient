...
*   [9\. Project templates](#project-templates)
    ...
    *   [9.1. List](#project-templates-list)
...
*   [48\. Project templates detail](#object-project-template-detail)
    ...
    *   [48.60. Notify policy](#object-notify-policy-detail)
...
[Register user](#auth-public-registry)
...
/api/v1/projects/{projectId}/issues\_stats
...
[Modify partially an epic status](#epic-statuses-edit)
...
[Modify user story](#user-stories-edit)
...
[Get user story voters](#user-stories-voters)
...
[Modify partially a user story custom attribute](#user-story-custom-attributes-edit)
...
[Modify task custom attribute](#task-custom-attributes-edit)
...
[List issue statuses](#issue-statuses-list)
...
[Modify partially a user](#users-edit)
...
[List project timeline](#timeline-project-list)
...
[List the Trello boards](#importers-trello-list-projects)
...
[List the users related to a Github board](#importers-github-list-users)

/api/v1/importers/github/import\_project

POST

[Import the Github project](#importers-github-import-project)

/api/v1/importers/jira/auth\_url

GET

[Get the authorization url](#importers-jira-auth-url)

/api/v1/importers/jira/authorize

POST

[Obtain the authorization token](#importers-jira-authorize)

/api/v1/importers/jira/list\_projects

POST

[List the Jira boards](#importers-jira-list-projects)

/api/v1/importers/jira/list\_users

POST

[List the users related to a Jira board](#importers-jira-list-users)

/api/v1/importers/jira/import\_project

POST

[Import the Jira project](#importers-jira-import-project)
...
When the login is successful, the HTTP response is a 200 OK and the response body is a JSON [user auth detail object](#object-auth-user-detail)
...
To get the GitHub code you have to follow the first step _Redirect users to request GitHub access_ described in [GitHub Documentation for Developers - API - OAuth - Web Application Flow](https://developer.github.com/v3/oauth/#web-application-flow).
...
When the refresh is successful, the HTTP response is a 200 OK and the response body is a JSON [refresh token detail object](#object-auth-refresh-detail)
...
When the registration is successful, the HTTP response is a 201 CREATED and the response body is a JSON [user auth detail object](#object-auth-user-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [application object](#object-application-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [application token object](#object-application-token-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [application token objects](#object-application-token-detail)
...
When the creation is successful, the HTTP response is a 200 and the response body is a JSON [authorization code object](#object-application-token-authorization-code)
...
When the creation is successful, the HTTP response is a 200 and the response body is a JSON [cyphered token object](#object-application-token-cyphered-token)
...
The HTTP response is a 200 OK and the response body is a JSON list of [search results detail objects](#object-search-results-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [user storage data objects](#object-user-storage-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [user storage data object](#object-user-storage-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [user storage data object](#object-user-storage-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [user storage data object](#object-user-storage-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [project template detail objects](#object-project-template-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [project template detail object](#object-project-template-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [project template detail object](#object-project-template-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [project template detail object](#object-project-template-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [project list entry objects](#object-project-list-entry)
...
The results can be ordered using the order\_by parameter with the values:

*   **memberships\_\_user\_order**: the project order specified by the user
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [project detail object](#object-project-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [project detail object](#object-project-detail)
...
When the edit is successful, the HTTP response is a 200 OK and the response body is a JSON [project detail object](#object-project-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [project modules configuration object](#object-project-modules-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [project stats object](#object-project-stats-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [project issue stats object](#object-project-issue-stats-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [project tag colors object](#object-project-tags-colors-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [project voter object](#object-project-voter-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [project watcher object](#object-project-watcher-detail)
...
When the change is successful, the HTTP response is a 200 OK and the response body is a JSON [project detail object](#object-project-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [membership detail objects](#object-membership-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [membership detail object](#object-membership-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON list of [membership detail object](#object-membership-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [membership detail object](#object-membership-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [membership detail object](#object-membership-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [role detail objects](#object-role-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [role detail object](#object-role-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [role detail object](#object-role-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [role detail object](#object-role-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [milestone detail objects](#object-milestone-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [milestone detail object](#object-milestone-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [milestone detail object](#object-milestone-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [milestone detail object](#object-milestone-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [milestone stats detail object](#object-milestone-stats-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [milestone watcher object](#object-milestone-watcher-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [epic list objects](#object-epic-detail-list)

The results can be filtered using the following parameters:

*   **project**: project id
    
*   **project\_\_slug**: project slug
    
*   **assigned\_to**: assigned to user id
    
*   **status\_\_is\_closed**: boolean indicating if the epic status is closed
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [epic detail object](#object-epic-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [epic detail (GET) object](#object-epic-detail-get)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [epic detail object](#object-epic-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON list of [epic detail object](#object-epic-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [epic filters data object](#object-epic-filters-data)
...
The HTTP response is a 200 OK and the response body is a JSON list of [epic related user story detail objects](#object-epic-related-user-story-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [epic related user story detail object](#object-epic-related-user-story-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [epic related user story detail object](#object-epic-related-user-story-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [epic related user story detail object](#object-epic-related-user-story-detail)
...
When the creation is successful, the HTTP response is a 201 OK and the response body is a JSON list of [epic related user story detail object](#object-epic-related-user-story-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [epic voter object](#object-epic-voter-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [epic watcher object](#object-epic-watcher-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [attachment detail objects](#object-attachment-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [attachment detail object](#object-attachment-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [attachment detail object](#object-attachment-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [attachment detail object](#object-attachment-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [epic status detail objects](#object-epic-status-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [epic status detail object](#object-epic-status-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [epic status detail object](#object-epic-status-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [epic status detail object](#object-epic-status-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [epic custom attribute detail objects](#object-epic-custom-attribute-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [epic custom attribute detail object](#object-epic-custom-attribute-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [epic custom attribute detail object](#object-epic-custom-attribute-detail)
...
When the update is successful, the HTTP response is a 200 OK and the response body is a JSON [epic custom attribute detail object](#object-epic-custom-attribute-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [epic custom attribute detail object](#object-epic-custom-attributes-values-detail)

### 17.2. Edit

To edit epic custom attributes values send a PUT or a PATCH specifying the epic id in the url. "attribute\_values" must be a JSON object with pairs epic custom atribute id - value. In a PATCH request you just need to send the modified data, in a PUT one the whole object must be sent.
...
When the update is successful, the HTTP response is a 200 OK and the response body is a JSON [epic custom attribute detail object](#object-epic-custom-attributes-values-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [user story list objects](#object-userstory-detail-list)
...
*   **status\_\_is\_archived**: (true|false)
...
*   **status\_\_is\_closed**: (true|false)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [user story detail object](#object-userstory-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [user story detail (GET) object](#object-userstory-detail-get)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [user story detail object](#object-userstory-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON list of [user story detail object](#object-userstory-detail)
...
When the update is successful, the HTTP response is a 200 OK and the response body is a JSON list of [user story detail object](#object-userstory-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [user story filters data object](#object-userstory-filters-data)
...
The HTTP response is a 200 OK and the response body is a JSON list of [user story voter object](#object-userstory-voter-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [user story watcher object](#object-userstory-watcher-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [user story status detail objects](#object-userstory-status-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [user story status detail object](#object-userstory-status-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [user story status detail object](#object-userstory-status-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [user story status detail object](#object-userstory-status-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [point detail objects](#object-point-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [point detail object](#object-point-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [point detail object](#object-point-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [point detail object](#object-point-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [user story custom attribute detail objects](#object-userstory-custom-attribute-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [user story custom attribute detail object](#object-userstory-custom-attribute-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [user story custom attribute detail object](#object-userstory-custom-attribute-detail)
...
When the update is successful, the HTTP response is a 200 OK and the response body is a JSON [user story custom attribute detail object](#object-userstory-custom-attribute-detail)
...
To edit user story custom attributes values send a PUT or a PATCH specifying the user story id in the url. "attribute\_values" must be a JSON object with pairs user story custom atribute id - value. In a PATCH request you just need to send the modified data, in a PUT one the whole object must be sent.
...
When the update is successful, the HTTP response is a 200 OK and the response body is a JSON [user story custom attribute detail object](#object-userstory-custom-attributes-values-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [task list objects](#object-task-detail-list)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [task detail object](#object-task-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [task detail (GET) object](#object-task-detail-get)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [task detail object](#object-task-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON list of [task detail object](#object-task-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [task filters data object](#object-task-filters-data)
...
The HTTP response is a 200 OK and the response body is a JSON list of [task voter object](#object-task-voter-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [task watcher object](#object-userstory-watcher-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [task status detail objects](#object-task-status-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [task status detail object](#object-task-status-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [task status detail object](#object-task-status-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [task status detail object](#object-task-status-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [task custom attribute detail objects](#object-task-custom-attribute-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [task custom attribute detail object](#object-task-custom-attribute-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [task custom attribute detail object](#object-task-custom-attribute-detail)
...
When the update is successful, the HTTP response is a 200 OK and the response body is a JSON [task custom attribute detail object](#object-task-custom-attribute-detail)
...
To edit task custom attributes values send a PUT or a PATCH specifying the task id in the url. "attribute\_values" must be a JSON object with pairs task custom atribute id - value. In a PATCH request you just need to send the modified data, in a PUT one the whole object must be sent.
...
When the update is successful, the HTTP response is a 200 OK and the response body is a JSON [task custom attribute detail object](#object-task-custom-attributes-values-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [issue detail list objects](#object-issue-detail-list)
...
*   **blocked\_note**: reason why the issue is blocked
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [issue detail object](#object-issue-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [issue detail (GET) object](#object-issue-detail-get)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [issue detail object](#object-issue-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [issue filters data object](#object-issue-filters-data)
...
The HTTP response is a 200 OK and the response body is a JSON [issue voters detail object](#object-issue-voters-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [issue watcher object](#object-issue-watcher-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [issue status detail objects](#object-issue-status-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [issue status detail object](#object-issue-status-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [issue status detail object](#object-issue-status-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [issue status detail object](#object-issue-status-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [issue type detail objects](#object-issue-type-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [issue type detail object](#object-issue-type-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [issue type detail object](#object-issue-type-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [issue type detail object](#object-issue-type-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [priority detail objects](#object-priority-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [priority detail object](#object-priority-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [priority detail object](#object-priority-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [priority detail object](#object-priority-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [severity detail objects](#object-severity-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [severity detail object](#object-severity-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [severity detail object](#object-severity-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [severity detail object](#object-severity-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [issue custom attribute detail objects](#object-issue-custom-attribute-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [issue custom attribute detail object](#object-issue-custom-attribute-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [issue custom attribute detail object](#object-issue-custom-attribute-detail)
...
When the update is successful, the HTTP response is a 200 OK and the response body is a JSON [issue custom attribute detail object](#object-issue-custom-attribute-detail)
...
To edit issue custom attributes values send a PUT or a PATCH specifying the issue id in the url. "attribute\_values" must be a JSON object with pairs issue custom atribute id - value. In a PATCH request you just need to send the modified data, in a PUT one the whole object must be sent.
...
When the update is successful, the HTTP response is a 200 OK and the response body is a JSON [issue custom attribute detail object](#object-issue-custom-attributes-values-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [wiki page detail objects](#object-wiki-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [wiki page detail object](#object-wiki-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [wiki page detail object](#object-wiki-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [wiki page detail object](#object-wiki-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [wiki page watcher object](#object-wiki-watcher-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [wiki link detail objects](#object-wiki-link-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [wiki link detail object](#object-wiki-link-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [wiki link detail object](#object-wiki-link-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [wiki link detail object](#object-wiki-link-detail)
...
The HTTP response is a 200 OK and the response body is a JSON of a list of [history entry detail objects](#object-history-entry-detail)
...
The HTTP response is a 200 OK and the response body is a JSON of a list of [history entry comment detail objects](#object-history-entry-comment-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [user detail objects](#object-user-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [user detail object](#object-user-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [user stats object](#object-user-stats-detail)
...
The HTTP response is a 200 OK and the response body is a list of JSON [watched detail object](#object-watched-detail)
...
The HTTP response is a 200 OK and the response body is a list of JSON [liked detail object](#object-liked-detail)
...
The HTTP response is a 200 OK and the response body is a list of JSON [voted detail object](#object-voted-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [user detail object](#object-user-detail)
...
The HTTP response is a 200 OK and the response body is a list of JSON [contact detail object](#object-contact-detail)
...
When the change is successful, the HTTP response is a 200 OK and the response body is a JSON [user detail object](#object-user-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [notify policy detail objects](#object-notify-policy-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [notify policy detail object](#object-notify-policy-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [notify policy detail object](#object-notify-policy-detail)
...
When created successfully, the HTTP response is a 201 Created and the response body is a JSON [feedback object](#object-feedback-detail)
...
*   If taiga is working in synchronous mode the json file is directly generated, the result is a 200 OK and as response body a JSON of [export detail for synch mode](#object-export-synch).
    
*   If taiga is working in asynchronous mode the result is a 202 Accepted and as response body a JSON of [export request accepted](#object-export-accepted). The export\_id can be used to build the URL to download the exported file when the file generation is complete, those urls look like: MEDIA\_URL/exports/PROJECT\_ID/PROJECT\_SLUG-export\_id.json.
...
*   A 202 Accepted and as response body a JSON of [import request accepted](#object-import-accepted).
    
*   A 201 Created and the response body is a JSON of [project detail object](#object-project-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [webhook detail objects](#object-webhook-detail)
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [webhook detail object](#object-webhook-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [webhook detail object](#object-webhook-detail)
...
When the creation is successful, the HTTP response is a 200 OK and the response body is a JSON [webhook detail object](#object-webhook-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [webhook log detail object](#object-webhook-log-detail) with the resault of the test.
...
The HTTP response is a 200 OK and the response body is a JSON list of [webhook log detail objects](#object-webhook-log-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [webhook log detail object](#object-webhook-log-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [webhook log detail object](#object-webhook-log-detail) with the resault of the resend.
...
The HTTP response is a 200 OK and the response body is a JSON list of [timeline entry detail](#object-timeline-detail)
...
The HTTP response is a 200 OK and the response body is a JSON list of [locale objects](#object-locale-detail)
...
The HTTP response is a 200 OK and the response body is a JSON [discover stats object](#object-discover-stats)
...
The HTTP response is a 200 OK and the response body is a JSON [system stats object](#object-system-stats)
...
*   A 200 Ok and the response body is a JSON of [importer auth url object](#object-importers-trello-auth-url)
...
*   A 200 Ok and the response body is a JSON of [importer auth token object](#object-importers-trello-auth-token)
...
*   A 200 Ok and the response body is a JSON of [list of importer users object](#object-importers-trello-list-users)
...
*   A 200 Ok and the response body is a JSON of [list of importer projects object](#object-importers-trello-list-projects)
...
*   If taiga is working in synchronous mode the result is a 200 OK and as response body a JSON of [imported project result](#object-importers-trello-import-project).
    
*   If taiga is working in asynchronous mode the result is a 202 Accepted and as response body a JSON of [import project accepted](#object-importers-task-accepted).
...
*   A 200 Ok and the response body is a JSON of [importer auth url object](#object-importers-github-auth-url)
...
*   A 200 Ok and the response body is a JSON of [importer auth token object](#object-importers-github-auth-token)
...
*   A 200 Ok and the response body is a JSON of [list of importer users object](#object-importers-github-list-users)
...
*   A 200 Ok and the response body is a JSON of [list of importer projects object](#object-importers-github-list-projects)
...
*   If taiga is working in synchronous mode the result is a 200 OK and as response body a JSON of [imported project result](#object-importers-github-import-project).
...
*   A 200 Ok and the response body is a JSON of [importer auth url object](#object-importers-jira-auth-url)
...
*   A 200 Ok and the response body is a JSON of [importer auth token object](#object-importers-jira-auth-token)
...
*   A 200 Ok and the response body is a JSON of [list of importer users object](#object-importers-jira-list-users)
...
*   A 200 Ok and the response body is a JSON of [list of importer projects object](#object-importers-jira-list-projects)
...
*   If taiga is working in synchronous mode the result is a 200 OK and as response body a JSON of [imported project result](#object-importers-jira-import-project).
...
When the creation is successful, the HTTP response is a 201 Created and the response body is a JSON [contact project object](#object-contact)
...
new mlPushMenu( document.getElementById( 'toc' ), document.getElementById( 'trigger' ), {type : 'cover'} ); $( ".mp-level\[data-level!=1\]" ).each( function() {$(this).parents("li").addClass('icon icon-arrow-left'); } );